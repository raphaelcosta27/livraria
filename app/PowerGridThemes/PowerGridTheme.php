...
class PowerGridTheme extends Tailwind
{
    ...
    public function table(): array
    {
        return [
            'layout' => [
                'base'      => 'p-1 align-middle inline-block min-w-full w-full sm:px-6 lg:px-8',
            ...
            'header' => [
                ...
                'tr'       => '',
                'th'       => 'font-extrabold px-1 py-1 text-pg-primary-700 tracking-wider whitespace-nowrap dark:text-pg-primary-300',
                'thAction' => '!font-bold',
            ],
            ...
            'body' => [
                ...
                'tbodyEmpty'         => '',
                // 'tr'                 => 'border-b border-pg-primary-100 text-xs dark:border-pg-primary-600 hover:bg-pg-primary-50 dark:bg-pg-primary-800 dark:hover:bg-pg-primary-700',
                'tr'                 => 'odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200',
                'td'                 => 'p-1 whitespace-nowrap dark:text-pg-primary-200',
                'tdEmpty'            => 'p-1 whitespace-nowrap dark:text-pg-primary-200',
                'tdSummarize'        => 'p-1 whitespace-nowrap dark:text-pg-primary-200 text-sm text-pg-primary-600 text-right space-y-2',
                'trSummarize'        => '',
                'tdFilters'          => '',
                'trFilters'          => '',
